...
public enum AnswerType {
    ...
    /**
     * The request has accepted been queued for later processing. The end message will contain a TaskOutput item with only its ID guaranteed to be
     * set.<br/>
     ...
     * This should be used for single action task that involve atomic and instantaneous changes - typically configuration changes on the server
     * itself.<br/>
     * This ends an exchange.
     */
    SUCCESS(2, false),
