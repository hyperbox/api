...
package io.kamax.hbox.module;

import java.net.URL;
import java.util.Set;

/**
 * A Module Class Loader is the magic behind the scenes that allow java code to be added at runtime without any packages
 * conflicts or others known initial limitations of Java.
 * <p>
 * Module ClassLoader will be internally made of a custom implementation of a ClassLoader. For an example, see the Client and Server implementation
 * for the default ModuleClassLoader class.<br/>
